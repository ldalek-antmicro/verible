...
const TreeUnwrapperTestData kUnwrapModuleTestCases[] = {
...

    {
        ...
        ModuleItemList(1, L(1, {"assign", "s", "=", "a", ",", "y",   "[", "0",
                                "]",      "=", "b", "[", "1", "]",   ",", "z",
                                ".",      "z", "=", "c", "-", "jkl", ";"})),
        L(0, {"endmodule"}),
    },

    {
        ...
        "endmodule",
        ModuleHeader(0, L(0, {"module", "foob", ";"})),
        ModuleItemList(1, L(1, {"assign", "`BIT_ASSIGN_MACRO", "(", "l1", ",",
                                "r1", ")"})),
        L(0, {"endmodule"}),
    },
...

    {
        ...
        "endmodule\n",
        ModuleHeader(0, L(0, {"module", "block_generate", ";"})),
        ModuleItemList(1, L(1, {"`ASSERT", "(", "blah", ")"}),
...
const TreeUnwrapperTestData kClassTestCases[] = {
...

    {
        ...
        ClassItemList(
            ...
            StatementList(
                2, L(2, {"begin"}),
                StatementList(3, L(3, {"this", ".", "size", "=", "size", ";"})),
                L(2, {"end"})),
            L(1, {"endfunction"}),
...

    {
        ...
        ClassItemList(
            ...
            StatementList(2, L(2, {"subroutine", "=", "a", "+", "42", ";"})),
            L(1, {"endfunction"})),
        L(0, {"endclass"}),
    },
...
const TreeUnwrapperTestData kUnwrapPreprocessorTestCases[] = {
...

    {
        ...
        ModuleItemList(
            1, L(1, {"always_comb", "begin"}),
            StatementList(2, L(2, {"x", "=", "y", ";"}),
                          L(0, {"`ifdef", "FOO"}), L(2, {"z", "=", "0", ";"}),
                          L(0, {"`endif"}), L(2, {"w", "=", "z", ";"})),
            L(1, {"end"})),
        L(0, {"endmodule"}),
    },
...
const TreeUnwrapperTestData kUnwrapTaskTestCases[] = {
...

    {
        ...
        "endtask",
        TaskHeader(0, L(0, {"task", "foo", ";"})),
        StatementList(1, L(1, {"$makeitso", "(", "x", ")", ";"})),
        L(0, {"endtask"}),
    },

    {
        ...
        "endtask",
        TaskHeader(0, L(0, {"task", "foo", ";"})),
        StatementList(1, L(1, {"y", "=", "makeitso", "(", "x", ")", ";"})),
        L(0, {"endtask"}),
    },

    {
        ...
        "endtask",
        TaskHeader(0, L(0, {"task", "foo", ";"})),
        StatementList(1, L(1, {"#", "100", "bar", "=", "13", ";"})),
        L(0, {"endtask"}),
    },
...

    {
        ...
        ClassItemList(
            ...
            StatementList(
                2,                                        //
                L(2, {"foo", ":", "z", "=", "v", ";"})),  // labeled assignment
            L(1, {"endtask"})),
        L(0, {"endclass"}),
    },
...

    {
        ...
        StatementList(
            ...
            FlowControl(
                ...
                StatementList(2, L(2, {"return", "1", ";"})), L(1, {"end"}))),
        L(0, {"endfunction"}),
    },
