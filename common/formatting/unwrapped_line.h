...
enum class PartitionPolicyEnum {
  ...
  // TODO(ldk): compact/rearrange partitions. its like kAppendFittingSubPartitions with
  //    the exception that it does not align with the 'header' partition
  kRearrangePartitions,
};
